<?php
      ...
      $sql = "SELECT*FROM berbagi WHERE category='uiux'";
...
<body>
      ...
      <div class="about marginDiv mb-5" style="text-align: center;">
            <h4>LEARN UIUX DESIGN ON WEBSITE</h4>
      </div>
            ...
            <table id="tabel-data" class="table table-striped table-bordered table-hover">
                  <thead>
                        ...
                        <tr style="color: #ffffff; font-style: normal;font-weight: 600;">
                              ...
                              <td style="text-transform: uppercase; text-align: center;"><?php echo $data[3]; ?></td>
                        </tr>
                        <?php endwhile; ?>
                  </thead>
            </table>
